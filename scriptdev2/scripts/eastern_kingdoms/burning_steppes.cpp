...
struct MANGOS_DLL_DECL npc_ragged_johnAI : public ScriptedAI
{
    ...
    {
        if (who->has_aura(16468))
        {
            if (who->GetTypeId() == TYPEID_PLAYER &&
                m_creature->IsWithinDistInMap(who, 15) &&
...
bool GossipHello_npc_ragged_john(Player* pPlayer, Creature* pCreature)
{
    ...
    if (pPlayer->GetQuestStatus(4224) == QUEST_STATUS_INCOMPLETE)
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT,
            "Official buisness, John. I need some information about Marsha "
            "Windsor. Tell me about the last time you saw him.",
