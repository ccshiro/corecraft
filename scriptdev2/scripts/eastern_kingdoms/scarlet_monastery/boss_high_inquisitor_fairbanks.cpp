...
SD%Complete: 100
SDComment: TODO: if this guy not involved in some special event, remove (and let
ACID script)
...
{
    boss_high_inquisitor_fairbanksAI(Creature* pCreature)
    ...
    void UpdateAI(const uint32 diff) override
    {
        ...
        if (m_creature->GetHealthPercent() <= 25.0f &&
            !m_creature->IsNonMeleeSpellCasted(false) && Heal_Timer < diff)
        {
