...
enum
{
    ...
    NPC_MADRIGOSA = 25160,
    NPC_FLIGHT_TRIGGER_LEFT = 25357, // Related to Felmyst flight path. Also the
                                     // anchor to summon Madrigosa
    // NPC_FLIGHT_TRIGGER_RIGHT = 25358,            // related to Felmyst flight
    // path
    NPC_BRUTALLUS = 24882,
    NPC_FELMYST = 25038,
    NPC_ALYTHESS = 25166,
    ...
    GO_ICE_BARRIER = 188119,     // used to block the players path during the
                                 // Brutallus intro event
    ...
    // Felmyst ouro spell
    SPELL_OPEN_BACK_DOOR =
        46650, // Opens the fire barrier - script effect for 46652
...
// Used to summon Felmyst in reload case. This is the place where Madrigosa is
// killed in the intro event
