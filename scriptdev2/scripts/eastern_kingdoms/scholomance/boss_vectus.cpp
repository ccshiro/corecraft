...
enum
{
    ...
    // SPELL_FRENZY                = 28371                   //spell is used by
    // Gluth, confirm this is for this boss too
    // SPELL_FIRE_SHIELD           = 0                       //should supposedly
    // have some aura, but proper spell not found
};
