...
enum
{
    ...
    // Because the shadow portal teleport coordinates are guesswork (taken from
    // old script) these IDs might be randomized
...
static const uint32 aGandlingEvents[MAX_EVENTS] = {EVENT_ID_POLKELT,
    EVENT_ID_THEOLEN, EVENT_ID_MALICIA, EVENT_ID_ILLUCIA, EVENT_ID_BAROV,
    EVENT_ID_RAVENIAN};
