...
struct MANGOS_DLL_DECL npc_deathstalker_erlandAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 i) override
    {
        ...
        case 14:
            if (Creature* pRane =
                    GetClosestCreatureWithEntry(m_creature, NPC_RANE, 45.0f))
        ...
        case 25:
            if (Creature* pQuinn =
                    GetClosestCreatureWithEntry(m_creature, NPC_QUINN, 45.0f))
...
bool QuestAccept_npc_deathstalker_erland(
    Player* pPlayer, Creature* pCreature, const Quest* pQuest)
{
    if (pQuest->GetQuestId() == QUEST_ERLAND)
    {
        ...
        if (npc_deathstalker_erlandAI* pEscortAI =
                dynamic_cast<npc_deathstalker_erlandAI*>(pCreature->AI()))
...
SpawnPoint SpawnPoints[] = {{-397.45f, 1509.56f, 18.87f, 4.73f},
    {-398.35f, 1510.75f, 18.87f, 4.76f}, {-396.41f, 1511.06f, 18.87f, 4.74f}};
...
struct MANGOS_DLL_DECL npc_deathstalker_faerleiaAI : public ScriptedAI
{
    ...
    void JustSummoned(Creature* pSummoned) override
    {
        ...
        auto pos =
            m_creature->GetPointXYZ(G3D::Vector3(m_afMoveCoords[0],
                                        m_afMoveCoords[1], m_afMoveCoords[2]),
            ...
            if (m_uiWaveCount == 4)
            {
                ...
                if (Player* pPlayer =
                    ...
                    pPlayer->GroupEventHappens(
                        QUEST_PYREWOOD_AMBUSH, m_creature);
    ...
    void UpdateAI(const uint32 uiDiff) override
    {
        if (m_bEventStarted && !m_uiSummonCount)
        {
            if (m_uiWaveTimer < uiDiff)
            {
                ...
                {
                case 0:
                    m_creature->SummonCreature(NPC_COUNCILMAN_SMITHERS,
                        SpawnPoints[1].fX, SpawnPoints[1].fY, SpawnPoints[1].fZ,
                        SpawnPoints[1].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    m_uiWaveTimer = 10000;
                    break;
                case 1:
                    m_creature->SummonCreature(NPC_COUNCILMAN_THATHER,
                        SpawnPoints[2].fX, SpawnPoints[2].fY, SpawnPoints[2].fZ,
                        SpawnPoints[2].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    m_creature->SummonCreature(NPC_COUNCILMAN_HENDRICKS,
                        SpawnPoints[1].fX, SpawnPoints[1].fY, SpawnPoints[1].fZ,
                        SpawnPoints[1].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    m_uiWaveTimer = 10000;
                    break;
                case 2:
                    m_creature->SummonCreature(NPC_COUNCILMAN_WILHELM,
                        SpawnPoints[1].fX, SpawnPoints[1].fY, SpawnPoints[1].fZ,
                        SpawnPoints[1].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    m_creature->SummonCreature(NPC_COUNCILMAN_HARTIN,
                        SpawnPoints[0].fX, SpawnPoints[0].fY, SpawnPoints[0].fZ,
                        SpawnPoints[0].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    m_creature->SummonCreature(NPC_COUNCILMAN_HIGARTH,
                        SpawnPoints[2].fX, SpawnPoints[2].fY, SpawnPoints[2].fZ,
                        SpawnPoints[2].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    m_uiWaveTimer = 8000;
                    break;
                case 3:
                    m_creature->SummonCreature(NPC_COUNCILMAN_COOPER,
                        SpawnPoints[1].fX, SpawnPoints[1].fY, SpawnPoints[1].fZ,
                        SpawnPoints[1].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    m_creature->SummonCreature(NPC_COUNCILMAN_BRUNSWICK,
                        SpawnPoints[2].fX, SpawnPoints[2].fY, SpawnPoints[2].fZ,
                        SpawnPoints[2].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    m_creature->SummonCreature(NPC_LORD_MAYOR_MORRISON,
                        SpawnPoints[0].fX, SpawnPoints[0].fY, SpawnPoints[0].fZ,
                        SpawnPoints[0].fO, TEMPSUMMON_CORPSE_TIMED_DESPAWN,
                        20000);
                    break;
...
bool QuestAccept_npc_deathstalker_faerleia(
    Player* pPlayer, Creature* pCreature, const Quest* pQuest)
{
    if (pQuest->GetQuestId() == QUEST_PYREWOOD_AMBUSH)
    {
        ...
        if (npc_deathstalker_faerleiaAI* pFaerleiaAI =
                dynamic_cast<npc_deathstalker_faerleiaAI*>(pCreature->AI()))
