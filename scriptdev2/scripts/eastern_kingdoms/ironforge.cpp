...
bool GossipHello_npc_royal_historian_archesonus(
    Player* pPlayer, Creature* pCreature)
{
    ...
    {
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_ITEM_ROYAL,
