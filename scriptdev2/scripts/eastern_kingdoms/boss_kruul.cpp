...
SDName: Boss_Kruul
SD%Complete: 100
SDComment: Highlord Kruul are presumably no longer in-game on regular bases,
however future events could bring him back.
SDCategory: Bosses
EndScriptData */
...
struct MANGOS_DLL_DECL boss_kruulAI : public ScriptedAI
{
    ...
    {
        // When a player, pet or totem gets killed, Lord Kazzak casts this spell
        // to instantly regenerate 70,000 health.
    ...
    void SummonHounds(Unit* victim)
    {
        ...
        Rand = 0;
        Summoned = DoSpawnCreature(19207, RandX, RandY, 0, 0,
