...
struct MANGOS_DLL_DECL npc_ranger_lilathaAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 i) override
    {
        ...
        {
        case 0:
            if (GameObject* pGoTemp =
                    GetClosestGameObjectWithEntry(m_creature, GO_CAGE, 10.0f))
            {
        ...
        case 1:
            if (GameObject* pGo =
                    m_creature->GetMap()->GetGameObject(m_goCageGuid))
        ...
        case 18:
            ...
            if (Creature* pSum1 = m_creature->SummonCreature(16342,
                    7627.083984f, -7532.538086f, 152.128616f, 1.082733f,
                    TEMPSUMMON_DEAD_DESPAWN, 0))
                pSum1->AI()->AttackStart(m_creature);
            if (Creature* pSum2 = m_creature->SummonCreature(16343,
                    7620.432129f, -7532.550293f, 152.454865f, 0.827478f,
                    TEMPSUMMON_DEAD_DESPAWN, 0))
        ...
        case 33:
            ...
            if (Creature* pHelios =
                    m_creature->GetMap()->GetCreature(m_heliosGuid))
...
bool QuestAccept_npc_ranger_lilatha(
    Player* pPlayer, Creature* pCreature, const Quest* pQuest)
{
    if (pQuest->GetQuestId() == QUEST_CATACOMBS)
    {
        ...
        if (npc_ranger_lilathaAI* pEscortAI =
                dynamic_cast<npc_ranger_lilathaAI*>(pCreature->AI()))
