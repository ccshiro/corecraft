...
struct TimeEventNpcInfo
{
    ...
    uint8 uiSavePosition; // stores in what order this npc was saved (0 means
                          // unsaved)
    ObjectGuid npGuid;
};
...
public:
    ...
    void SetBearEventProgress(bool bIsInProgress)
    {
        m_bIsBearPhaseInProgress = bIsInProgress;
    }
