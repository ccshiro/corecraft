...
instance_magisters_terrace::instance_magisters_terrace(Map* pMap)
  : ScriptedInstance(pMap), m_uiDelrissaDeathCount(0)
{
    Initialize();
}
...
void instance_magisters_terrace::GetFelCrystalList(GUIDList& lList)
{
    if (m_lFelCrystalGuid.empty())
        logging.error(
            "SD2: Magisters Terrace: No Fel Crystals loaded in Inst Data");
