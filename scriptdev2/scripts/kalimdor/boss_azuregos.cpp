...
enum
{
    ...
    SPELL_MARK_OF_FROST_AURA = 23184, // Triggers 23186 on players that have
                                      // 23182; unfortunatelly 23183 is missing
                                      // from dbc
...
struct MANGOS_DLL_DECL boss_azuregosAI : public ScriptedAI
{
    ...
    void KilledUnit(Unit* pVictim) override
    {
        ...
        if (pVictim->GetTypeId() == TYPEID_PLAYER)
            pVictim->CastSpell(pVictim, SPELL_MARK_OF_FROST_PLAYER, true, NULL,
                NULL, m_creature->GetObjectGuid());
    }

    void Aggro(Unit* /*pWho*/) override
    {
        // Boss aura which triggers the stun effect on dead players who
        // resurrect
