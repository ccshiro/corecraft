...
static const float aBoarSpawn[4][3] = {{2151.420f, 1733.18f, 52.10f},
    {2144.463f, 1726.89f, 51.93f}, {1956.433f, 1597.97f, 81.75f},
...
struct MANGOS_DLL_DECL npc_willix_the_importerAI : public npc_escortAI
{
    ...
    // Exact use of these texts remains unknown, it seems that he should only
    // talk when he initiates the attack or he is the first who is attacked by a
    // npc
    ...
    void WaypointReached(uint32 uiPointId) override
    {
        ...
        case 14:
            ...
            m_creature->SummonCreature(NPC_RAGING_AGAMAR, aBoarSpawn[0][0],
                aBoarSpawn[0][1], aBoarSpawn[0][2], 0,
                TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
            m_creature->SummonCreature(NPC_RAGING_AGAMAR, aBoarSpawn[1][0],
                aBoarSpawn[1][1], aBoarSpawn[1][2], 0,
                TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
            break;
        case 25:
        ...
        case 44:
            ...
            m_creature->SummonCreature(NPC_RAGING_AGAMAR, aBoarSpawn[2][0],
                aBoarSpawn[2][1], aBoarSpawn[2][2], 0,
                TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
            m_creature->SummonCreature(NPC_RAGING_AGAMAR, aBoarSpawn[3][0],
                aBoarSpawn[3][1], aBoarSpawn[3][2], 0,
                TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 25000);
            break;
        case 45:
            ...
            if (Player* pPlayer = GetPlayerForEscort())
                pPlayer->GroupEventHappens(
                    QUEST_WILLIX_THE_IMPORTER, m_creature);
...
bool QuestAccept_npc_willix_the_importer(
    Player* pPlayer, Creature* pCreature, const Quest* pQuest)
{
    if (pQuest->GetQuestId() == QUEST_WILLIX_THE_IMPORTER)
    {
        if (npc_willix_the_importerAI* pEscortAI =
                dynamic_cast<npc_willix_the_importerAI*>(pCreature->AI()))
        {
