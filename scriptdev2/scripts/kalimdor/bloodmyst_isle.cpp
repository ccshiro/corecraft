...
const uint32 possibleSpawns[31] = {17322, 17661, 17496, 17522, 17340, 17352,
    17333, 17524, 17654, 17348, 17339, 17345, 17359, 17353, 17336, 17550, 17330,
    17701, 17321, 17325, 17320, 17683, 17342, 17715, 17334, 17341, 17338, 17337,
    17346, 17344, 17327};
    ...
    void JustDied(Unit* Killer) override
    {
        ...
        case 0:
            ...
            if (Killer->GetTypeId() == TYPEID_PLAYER)
                ((Player*)Killer)
                    ->KilledMonsterCredit(
                        spawnCreatureID, m_creature->GetObjectGuid());
            break;
        case 1:
        case 2:
        ...
        if (spawnCreatureID)
            m_creature->SummonCreature(spawnCreatureID, 0.0f, 0.0f, 0.0f,
