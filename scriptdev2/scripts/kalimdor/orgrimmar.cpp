...
struct MANGOS_DLL_DECL npc_shenthulAI : public ScriptedAI
{
    ...
    void ReceiveEmote(Player* pPlayer, uint32 emote) override
    {
        if (emote == TEXTEMOTE_SALUTE &&
            pPlayer->GetQuestStatus(QUEST_SHATTERED_SALUTE) ==
...
bool GossipHello_npc_thrall_warchief(Player* pPlayer, Creature* pCreature)
{
    ...
    if (pPlayer->GetQuestStatus(QUEST_6566) == QUEST_STATUS_INCOMPLETE)
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT,
            "Please share your wisdom with me, Warchief.", GOSSIP_SENDER_MAIN,
    ...
    Player* pPlayer, Creature* pCreature, uint32 /*uiSender*/, uint32 uiAction)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 5:
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT,
            "I live only to serve, Warchief! My life is empty and meaningless "
