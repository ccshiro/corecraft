...
{
    pPlayer->ADD_GOSSIP_ITEM_EXTENDED(0, GOSSIP_ITEM_1, GOSSIP_SENDER_MAIN,
        GOSSIP_ACTION_INFO_DEF + 1, "", 0, true);
...
// This function is called when the player clicks an option on the gossip
// menubool
bool GossipSelect_example_gossip_codebox(
...
bool GossipSelectWithCode_example_gossip_codebox(Player* pPlayer,
    Creature* pCreature, uint32 uiSender, uint32 uiAction, const char* sCode)
{
...
void AddSC_example_gossip_codebox()
{
    ...
    pNewScript->pGossipSelectWithCode =
        &GossipSelectWithCode_example_gossip_codebox;
