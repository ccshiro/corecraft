...
enum
{
    ...
    NPC_FEL_ORC_NEOPHYTE = 17429, // Also used in the event
    ...
    GO_CELL_DOOR_LEVER = 181982,

    // GO_PRISON_CELL_MAKER1        = 181813,               // The maker cell
    // front right
    // GO_PRISON_CELL_MAKER2        = 181814,               // The maker cell
    // back right
    // GO_PRISON_CELL_MAKER3        = 181816,               // The maker cell
    // front left
    // GO_PRISON_CELL_MAKER4        = 181815,               // The maker cell
    // back left
...
private:
    ...
    uint32 m_uiBroggokEventTimer; // Timer for opening the event cages; only on
                                  // heroic mode = 30 secs
    uint32 m_uiBroggokEventPhase;

    GUIDList m_luiNascentOrcGuids;

    bool m_bHasFixedOrcsForBroggok;
    uint32 m_uiBroggokFixTimer;
};
