...
void WorldSession::HandleDuelAcceptedOpcode(WorldPacket& recvPacket)
{
    ...
    LOG_DEBUG(logging, "WORLD: received CMSG_DUEL_ACCEPTED");
    LOG_DEBUG(logging, "Player 1 is: %u (%s)", pl->GetGUIDLow(), pl->GetName());
    LOG_DEBUG(logging, "Player 2 is: %u (%s)", plTarget->GetGUIDLow(),
        plTarget->GetName());
