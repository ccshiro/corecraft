...
enum BG_EY_WorldStates
{
    ...
    PROGRESS_BAR_SHOW =
        2718, // 1 init, 0 druhy send - bez messagu, 1 = controlled alliance
...
// node-events work like this: event1:nodeid, event2:state
// (0alliance,1horde,2neutral)
...
{
    BattleGroundEYLoosingPointStruct(
        uint32 _MessageIdAlliance, uint32 _MessageIdHorde)
...
struct BattleGroundEYCapturingPointStruct
{
    BattleGroundEYCapturingPointStruct(
        uint32 _MessageIdAlliance, uint32 _MessageIdHorde, uint32 _GraveYardId)
      : MessageIdAlliance(_MessageIdAlliance), MessageIdHorde(_MessageIdHorde),
...
const BattleGroundEYPointIconsStruct PointsIconStruct[BG_EY_NODES_MAX] = {
    BattleGroundEYPointIconsStruct(FEL_REAVER_UNCONTROL,
        FEL_REAVER_ALLIANCE_CONTROL, FEL_REAVER_HORDE_CONTROL),
    BattleGroundEYPointIconsStruct(BLOOD_ELF_UNCONTROL,
        BLOOD_ELF_ALLIANCE_CONTROL, BLOOD_ELF_HORDE_CONTROL),
    BattleGroundEYPointIconsStruct(DRAENEI_RUINS_UNCONTROL,
        DRAENEI_RUINS_ALLIANCE_CONTROL, DRAENEI_RUINS_HORDE_CONTROL),
    BattleGroundEYPointIconsStruct(MAGE_TOWER_UNCONTROL,
        MAGE_TOWER_ALLIANCE_CONTROL, MAGE_TOWER_HORDE_CONTROL)};
...
const BattleGroundEYCapturingPointStruct CapturingPointTypes[BG_EY_NODES_MAX] =
    {BattleGroundEYCapturingPointStruct(LANG_BG_EY_HAS_TAKEN_A_F_RUINS,
         LANG_BG_EY_HAS_TAKEN_H_F_RUINS, EY_GRAVEYARD_FEL_REAVER),
     BattleGroundEYCapturingPointStruct(LANG_BG_EY_HAS_TAKEN_A_B_TOWER,
         LANG_BG_EY_HAS_TAKEN_H_B_TOWER, EY_GRAVEYARD_BLOOD_ELF),
     BattleGroundEYCapturingPointStruct(LANG_BG_EY_HAS_TAKEN_A_D_RUINS,
         LANG_BG_EY_HAS_TAKEN_H_D_RUINS, EY_GRAVEYARD_DRAENEI_RUINS),
     BattleGroundEYCapturingPointStruct(LANG_BG_EY_HAS_TAKEN_A_M_TOWER,
         LANG_BG_EY_HAS_TAKEN_H_M_TOWER, EY_GRAVEYARD_MAGE_TOWER)};
...
public:
    BattleGroundEY(const battlefield::bracket& bracket);
    ~BattleGroundEY();
...
private:
    void EventPlayerCapturedFlagEY(Player* Source, BG_EY_Nodes node);
    ...
    /* Scorekeeping */
    uint32 GetTeamScore(Team team) const
    {
