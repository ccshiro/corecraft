...
public:
    ...
    bool Disband(WorldSession* session);
    ...
    bool DelMember(ObjectGuid guid, bool ignore_checks = false);

    void SetEmblem(uint32 backgroundColor, uint32 emblemStyle,
    ...
    void BroadcastEvent(ArenaTeamEvents event, ObjectGuid guid,
        char const* str1 = nullptr, char const* str2 = nullptr,
        char const* str3 = nullptr);
    void BroadcastEvent(ArenaTeamEvents event, char const* str1 = nullptr,
    ...
    void RegisterFinishedMatch(uint32 opponents_id,
        const std::vector<ObjectGuid>& players, uint32 new_rating, bool won);
    void PersonalRatingUpdate(
