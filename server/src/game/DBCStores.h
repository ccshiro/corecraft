...
MANGOS_DLL_SPEC AreaTableEntry const* GetAreaEntryByAreaFlagAndMap(
...
bool IsPointInAreaTriggerZone(AreaTriggerEntry const* atEntry, uint32 mapid,
    float x, float y, float z, float delta = 0.0f);

// See vmap/MapTree.cpp)
...
extern DBCStorage<AreaTableEntry>
    sAreaStore; // recommend access using functions
...
// extern DBCStorage <ItemDisplayInfoEntry>      sItemDisplayInfoStore; -- not
// used currently
