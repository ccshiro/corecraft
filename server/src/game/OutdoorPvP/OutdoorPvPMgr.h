...
enum
{
    TIMER_OPVP_MGR_UPDATE = MINUTE * IN_MILLISECONDS // 1 minute is enough for
                                                     // us but this might change
                                                     // with wintergrasp support
};
...
public:
    ...
    void SetCapturePointSlider(uint32 entry, float value)
    {
...
private:
    ...
    typedef std::map<uint32 /*capture point entry*/, float /*slider value*/>
...
#define sOutdoorPvPMgr MaNGOS::Singleton<OutdoorPvPMgr>
