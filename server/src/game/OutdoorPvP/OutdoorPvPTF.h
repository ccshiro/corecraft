...
static const TerokkarTowerEvent terokkarTowerEvents[MAX_TF_TOWERS][4] = {
    {
     {EVENT_WEST_TOWER_PROGRESS_ALLIANCE, ALLIANCE,
      LANG_OPVP_TF_CAPTURE_TOWER_A, WORLD_STATE_TF_WEST_TOWER_ALLIANCE},
     {EVENT_WEST_TOWER_PROGRESS_HORDE, HORDE, LANG_OPVP_TF_CAPTURE_TOWER_H,
      WORLD_STATE_TF_WEST_TOWER_HORDE},
     {EVENT_WEST_TOWER_NEUTRAL_HORDE, TEAM_NONE, LANG_OPVP_TF_LOSE_TOWER_A,
      WORLD_STATE_TF_WEST_TOWER_NEUTRAL},
     {EVENT_WEST_TOWER_NEUTRAL_ALLIANCE, TEAM_NONE, LANG_OPVP_TF_LOSE_TOWER_H,
      WORLD_STATE_TF_WEST_TOWER_NEUTRAL},
    },
    {
     {EVENT_NORTH_TOWER_PROGRESS_ALLIANCE, ALLIANCE,
      LANG_OPVP_TF_CAPTURE_TOWER_A, WORLD_STATE_TF_NORTH_TOWER_ALLIANCE},
     {EVENT_NORTH_TOWER_PROGRESS_HORDE, HORDE, LANG_OPVP_TF_CAPTURE_TOWER_H,
      WORLD_STATE_TF_NORTH_TOWER_HORDE},
     {EVENT_NORTH_TOWER_NEUTRAL_HORDE, TEAM_NONE, LANG_OPVP_TF_LOSE_TOWER_A,
      WORLD_STATE_TF_NORTH_TOWER_NEUTRAL},
     {EVENT_NORTH_TOWER_NEUTRAL_ALLIANCE, TEAM_NONE, LANG_OPVP_TF_LOSE_TOWER_H,
      WORLD_STATE_TF_NORTH_TOWER_NEUTRAL},
    },
    {
     {EVENT_EAST_TOWER_PROGRESS_ALLIANCE, ALLIANCE,
      LANG_OPVP_TF_CAPTURE_TOWER_A, WORLD_STATE_TF_EAST_TOWER_ALLIANCE},
     {EVENT_EAST_TOWER_PROGRESS_HORDE, HORDE, LANG_OPVP_TF_CAPTURE_TOWER_H,
      WORLD_STATE_TF_EAST_TOWER_HORDE},
     {EVENT_EAST_TOWER_NEUTRAL_HORDE, TEAM_NONE, LANG_OPVP_TF_LOSE_TOWER_A,
      WORLD_STATE_TF_EAST_TOWER_NEUTRAL},
     {EVENT_EAST_TOWER_NEUTRAL_ALLIANCE, TEAM_NONE, LANG_OPVP_TF_LOSE_TOWER_H,
      WORLD_STATE_TF_EAST_TOWER_NEUTRAL},
    },
    {
     {EVENT_SOUTH_EAST_TOWER_PROGRESS_ALLIANCE, ALLIANCE,
      LANG_OPVP_TF_CAPTURE_TOWER_A, WORLD_STATE_TF_SOUTH_EAST_TOWER_ALLIANCE},
     {EVENT_SOUTH_EAST_TOWER_PROGRESS_HORDE, HORDE,
      LANG_OPVP_TF_CAPTURE_TOWER_H, WORLD_STATE_TF_SOUTH_EAST_TOWER_HORDE},
     {EVENT_SOUTH_EAST_TOWER_NEUTRAL_HORDE, TEAM_NONE,
      LANG_OPVP_TF_LOSE_TOWER_A, WORLD_STATE_TF_SOUTH_EAST_TOWER_NEUTRAL},
     {EVENT_SOUTH_EAST_TOWER_NEUTRAL_ALLIANCE, TEAM_NONE,
      LANG_OPVP_TF_LOSE_TOWER_H, WORLD_STATE_TF_SOUTH_EAST_TOWER_NEUTRAL},
    },
    {
     {EVENT_SOUTH_TOWER_PROGRESS_ALLIANCE, ALLIANCE,
      LANG_OPVP_TF_CAPTURE_TOWER_A, WORLD_STATE_TF_SOUTH_TOWER_ALLIANCE},
     {EVENT_SOUTH_TOWER_PROGRESS_HORDE, HORDE, LANG_OPVP_TF_CAPTURE_TOWER_H,
      WORLD_STATE_TF_SOUTH_TOWER_HORDE},
     {EVENT_SOUTH_TOWER_NEUTRAL_HORDE, TEAM_NONE, LANG_OPVP_TF_LOSE_TOWER_A,
      WORLD_STATE_TF_SOUTH_TOWER_NEUTRAL},
     {EVENT_SOUTH_TOWER_NEUTRAL_ALLIANCE, TEAM_NONE, LANG_OPVP_TF_LOSE_TOWER_H,
      WORLD_STATE_TF_SOUTH_TOWER_NEUTRAL},
    },
};

static const uint32 terokkarTowers[MAX_TF_TOWERS] = {GO_TOWER_BANNER_WEST,
    GO_TOWER_BANNER_NORTH, GO_TOWER_BANNER_EAST, GO_TOWER_BANNER_SOUTH_EAST,
    GO_TOWER_BANNER_SOUTH};
...
public:
    ...
    Team GetOwningTeam() const override;

private:
    void UpdateTimerWorldState();

    // process capture events
    bool ProcessCaptureEvent(
