...
const creature_type HordeControlNPCs[20] = {{18816, HORDE, 530, 1002785},
    {18821, HORDE, 530, 1002786}, {21474, HORDE, 530, 1002787},
    {21484, HORDE, 530, 1002788}, {21483, HORDE, 530, 1002789},

    {18192, HORDE, 530, 1002755}, {18192, HORDE, 530, 1002756},
    {18192, HORDE, 530, 1002757}, {18192, HORDE, 530, 1002758},
    {18192, HORDE, 530, 1002759}, {18192, HORDE, 530, 1002760},
    {18192, HORDE, 530, 1002761}, {18192, HORDE, 530, 1002762},
    {18192, HORDE, 530, 1002763}, {18192, HORDE, 530, 1002764},
    {18192, HORDE, 530, 1002765}, {18192, HORDE, 530, 1002766},
    {18192, HORDE, 530, 1002767}, {18192, HORDE, 530, 1002768},
    {18192, HORDE, 530, 1002769}};

const creature_type AllianceControlNPCs[20] = {{18817, ALLIANCE, 530, 1002790},
    {18822, ALLIANCE, 530, 1002791}, {21485, ALLIANCE, 530, 1002792},
    {21487, ALLIANCE, 530, 1002793}, {21488, ALLIANCE, 530, 1002794},

    {18256, ALLIANCE, 530, 1002770}, {18256, ALLIANCE, 530, 1002771},
    {18256, ALLIANCE, 530, 1002772}, {18256, ALLIANCE, 530, 1002773},
    {18256, ALLIANCE, 530, 1002774}, {18256, ALLIANCE, 530, 1002775},
    {18256, ALLIANCE, 530, 1002776}, {18256, ALLIANCE, 530, 1002777},
    {18256, ALLIANCE, 530, 1002778}, {18256, ALLIANCE, 530, 1002779},
    {18256, ALLIANCE, 530, 1002780}, {18256, ALLIANCE, 530, 1002781},
    {18256, ALLIANCE, 530, 1002782}, {18256, ALLIANCE, 530, 1002783},
    {18256, ALLIANCE, 530, 1002784}};

const uint32 FlightPathStartNodes[4] = {103, 105, 107, 109};
const uint32 FlightPathEndNodes[4] = {104, 106, 108, 110};

static const uint32 nagrandRoostsAlliance[MAX_NA_ROOSTS] = {
    GO_WYVERN_ROOST_ALLIANCE_SOUTH, GO_WYVERN_ROOST_ALLIANCE_WEST,
    GO_WYVERN_ROOST_ALLIANCE_NORTH, GO_WYVERN_ROOST_ALLIANCE_EAST};
static const uint32 nagrandRoostsHorde[MAX_NA_ROOSTS] = {
    GO_WYVERN_ROOST_HORDE_SOUTH, GO_WYVERN_ROOST_HORDE_WEST,
    GO_WYVERN_ROOST_HORDE_NORTH, GO_WYVERN_ROOST_HORDE_EAST};
static const uint32 nagrandRoostsBrokenAlliance[MAX_NA_ROOSTS] = {
    GO_DESTROYED_ROOST_ALLIANCE_SOUTH, GO_DESTROYED_ROOST_ALLIANCE_NORTH,
    GO_DESTROYED_ROOST_ALLIANCE_EAST, GO_DESTROYED_ROOST_ALLIANCE_WEST};
static const uint32 nagrandRoostsBrokenHorde[MAX_NA_ROOSTS] = {
    GO_DESTROYED_ROOST_HORDE_SOUTH, GO_DESTROYED_ROOST_HORDE_NORTH,
    GO_DESTROYED_ROOST_HORDE_EAST, GO_DESTROYED_ROOST_HORDE_WEST};
static const uint32 nagrandWagonsAlliance[MAX_NA_ROOSTS] = {
    GO_BOMB_WAGON_ALLIANCE_SOUTH, GO_BOMB_WAGON_ALLIANCE_NORTH,
    GO_BOMB_WAGON_ALLIANCE_EAST, GO_BOMB_WAGON_ALLIANCE_WEST};
static const uint32 nagrandWagonsHorde[MAX_NA_ROOSTS] = {
    GO_BOMB_WAGON_HORDE_SOUTH, GO_BOMB_WAGON_HORDE_NORTH,
    GO_BOMB_WAGON_HORDE_EAST, GO_BOMB_WAGON_HORDE_WEST};

static const uint32 nagrandRoostStatesAlliance[MAX_NA_ROOSTS] = {
    WORLD_STATE_NA_WYVERN_SOUTH_A, WORLD_STATE_NA_WYVERN_NORTH_A,
    WORLD_STATE_NA_WYVERN_EAST_A, WORLD_STATE_NA_WYVERN_WEST_A};
static const uint32 nagrandRoostStatesHorde[MAX_NA_ROOSTS] = {
    WORLD_STATE_NA_WYVERN_SOUTH_H, WORLD_STATE_NA_WYVERN_NORTH_H,
    WORLD_STATE_NA_WYVERN_EAST_H, WORLD_STATE_NA_WYVERN_WEST_H};
static const uint32 nagrandRoostStatesAllianceNeutral[MAX_NA_ROOSTS] = {
    WORLD_STATE_NA_WYVERN_SOUTH_NEUTRAL_A,
    WORLD_STATE_NA_WYVERN_NORTH_NEUTRAL_A, WORLD_STATE_NA_WYVERN_EAST_NEUTRAL_A,
    WORLD_STATE_NA_WYVERN_WEST_NEUTRAL_A};
static const uint32 nagrandRoostStatesHordeNeutral[MAX_NA_ROOSTS] = {
    WORLD_STATE_NA_WYVERN_SOUTH_NEUTRAL_H,
    WORLD_STATE_NA_WYVERN_NORTH_NEUTRAL_H, WORLD_STATE_NA_WYVERN_EAST_NEUTRAL_H,
...
public:
    ...
    void HandleObjectiveComplete(
        uint32 eventId, std::list<Player*> players, Team team) override;
...
private:
    ...
    void SpawnNPCsForTeam(Team team, GameObject* go);
    ...
    std::list<ObjectGuid> Horde_CreatureGuids;
    std::list<ObjectGuid> Alliance_CreatureGuids;
