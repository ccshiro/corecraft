...
#define SOCIALMGR_IGNORE_LIMIT \
    25 // checked max for 2.4.3, list tail not show if more
...
public:
    ...
    void GetFriendInfo(
        Player* player, uint32 friendGUID, FriendInfo& friendInfo);
    // Packet management
    void MakeFriendStatusPacket(
        FriendsResult result, uint32 friend_guid, WorldPacket* data);
...
#define sSocialMgr MaNGOS::UnlockedSingleton<SocialMgr>
#endif
