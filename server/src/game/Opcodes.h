...
enum Opcodes
{
    ...
    MSG_GUILD_BANK_MONEY_WITHDRAWAL_AVAILABLE = 0x3FD,
...
// Don't forget to change this value and add opcode name to Opcodes.cpp when you
// add new opcode!
...
enum SessionStatus
{
    STATUS_AUTHED = 0, ///< Player authenticated (_player==NULL,
    /// m_playerRecentlyLogout = false or will be reset before
    /// handler call)
    STATUS_LOGGEDIN, ///< Player in game (_player!=NULL, inWorld())
    STATUS_TRANSFER, ///< Player transferring to another map (_player!=NULL,
                     ///!inWorld())
    STATUS_LOGGEDIN_OR_RECENTLY_LOGGEDOUT, ///< _player!= NULL or _player==NULL
                                           ///&& m_playerRecentlyLogout)
    STATUS_NEVER, ///< Opcode not accepted from client (deprecated or server
    /// side only)
