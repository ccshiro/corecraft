...
enum MangosStrings
{
    ...
    LANG_RA_USER = 61,
    LANG_RA_PASS = 62,
    // LANG_GM_ACCEPTS_WHISPER             = 63, not used
    // LANG_GM_NO_WHISPER                  = 64, not used
    ...
    LANG_BG_GROUP_MIXED_FACTION = 728,  // "Your group has players from the
                                        // opposing faction. You can't join the
                                        // battleground as a group."
    LANG_BG_GROUP_MIXED_LEVELS = 729, // "Your group has players from different
                                      // battleground brakets. You can't join as
                                      // group."
    ...
    LANG_MOVEGENS_RANDOM2 = 1194,
    LANG_MOVEGENS_CHARGE = 1195,
    LANG_MOVEGENS_GWP = 1196,
    ...
    // `db_script_string` table index     2000000000-2000009999
