...
enum AuraFlags
{
    AFLAG_UNK1 = 0x01, // Guess: Effect 1 of the spell is an aura
    AFLAG_UNK2 = 0x02, // Guess: Effect 1 of the spell is an aura
    AFLAG_UNK3 = 0x04, // Guess: Effect 1 of the spell is an aura
    AFLAG_UNK4 = 0x08, // Note: All currently observed data has this toggled on
                       // and at least one of the three previous
    AFLAG_ACTIVE_AND_REMOVABLE = 0x10, // Present if the aura is active &
                                       // removable. This is NOT present ONLY
                                       // for area auras that is owned by
                                       // someone else than the target.
    AFLAG_MASK = 0xFF
};
...
enum AuraType
{
    ...
    SPELL_AURA_MOD_FLAT_SPELL_CRIT_DAMAGE_VERSUS =
        181, // unused - possible flat spell crit damage versus
    ...
    SPELL_AURA_MOD_DEPRICATED_1 =
        194, // not used now, old SPELL_AURA_MOD_SPELL_DAMAGE_OF_INTELLECT
    SPELL_AURA_MOD_DEPRICATED_2 =
        195, // not used now, old SPELL_AURA_MOD_SPELL_HEALING_OF_INTELLECT
