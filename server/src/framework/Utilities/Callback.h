...
template <class Class, typename ParamType1 = void, typename ParamType2 = void,
    typename ParamType3 = void, typename ParamType4 = void>
class _Callback
{
protected:
    typedef void (Class::*Method)(
        ParamType1, ParamType2, ParamType3, ParamType4);
    Class* m_object;
    Method m_method;
    ParamType1 m_param1;
    ParamType2 m_param2;
...
public:
    ...
    _Callback(_Callback<Class, ParamType1, ParamType2, ParamType3,
        ParamType4> const& cb)
...
public:
    ...
    _Callback(_Callback<Class, ParamType1, ParamType2, ParamType3> const& cb)
      : m_object(cb.m_object), m_method(cb.m_method), m_param1(cb.m_param1),
        m_param2(cb.m_param2), m_param3(cb.m_param3)
    {
    }
};
...
public:
    _Callback(
        Class* object, Method method, ParamType1 param1, ParamType2 param2)
      : m_object(object), m_method(method), m_param1(param1), m_param2(param2)
    {
    }
...
template <typename ParamType1 = void, typename ParamType2 = void,
    typename ParamType3 = void, typename ParamType4 = void>
class _SCallback
{
protected:
...
public:
    ...
    _SCallback(
        _SCallback<ParamType1, ParamType2, ParamType3, ParamType4> const& cb)
...
public:
    _SCallback(
        Method method, ParamType1 param1, ParamType2 param2, ParamType3 param3)
...
public:
    Callback(Class* object, typename C4::Method method, ParamType1 param1,
        ParamType2 param2, ParamType3 param3, ParamType4 param4)
...
public:
    Callback(Class* object, typename C3::Method method, ParamType1 param1,
        ParamType2 param2, ParamType3 param3)
...
public:
    Callback(Class* object, typename C2::Method method, ParamType1 param1,
        ParamType2 param2)
...
class QueryCallback
    : public _IQueryCallback<
          _Callback<Class, QueryResult*, ParamType1, ParamType2, ParamType3>>
{
private:
    typedef _Callback<Class, QueryResult*, ParamType1, ParamType2, ParamType3>
        QC3;

public:
    QueryCallback(Class* object, typename QC3::Method method,
        QueryResult* result, ParamType1 param1, ParamType2 param2,
        ParamType3 param3)
      : _IQueryCallback<QC3>(
            QC3(object, method, result, param1, param2, param3))
    {
    }
};
...
class QueryCallback<Class, ParamType1, ParamType2>
    : public _IQueryCallback<
          _Callback<Class, QueryResult*, ParamType1, ParamType2>>
{
private:
    typedef _Callback<Class, QueryResult*, ParamType1, ParamType2> QC2;

public:
    QueryCallback(Class* object, typename QC2::Method method,
        QueryResult* result, ParamType1 param1, ParamType2 param2)
...
public:
    QueryCallback(Class* object, typename QC1::Method method,
        QueryResult* result, ParamType1 param1)
...
public:
    QueryCallback(
        Class* object, typename QC0::Method method, QueryResult* result)
...
class SQueryCallback
    : public _IQueryCallback<
          _SCallback<QueryResult*, ParamType1, ParamType2, ParamType3>>
{
private:
    typedef _SCallback<QueryResult*, ParamType1, ParamType2, ParamType3> QC3;

public:
    SQueryCallback(typename QC3::Method method, QueryResult* result,
...
public:
    SQueryCallback(typename QC2::Method method, QueryResult* result,
...
public:
    SQueryCallback(
        typename QC1::Method method, QueryResult* result, ParamType1 param1)
