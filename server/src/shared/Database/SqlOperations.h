...
private:
    ...
    MaNGOS::locked_queue<MaNGOS::IQueryCallback*>* m_queue;

public:
    SqlQuery(const char* sql, MaNGOS::IQueryCallback* callback,
        MaNGOS::locked_queue<MaNGOS::IQueryCallback*>* queue)
...
private:
    typedef MaNGOS::locked_queue<MaNGOS::IQueryCallback*> locked_queue;
...
public:
    ...
    bool Execute(MaNGOS::IQueryCallback* callback, SqlDelayThread* thread,
        locked_queue* queue);
};
...
private:
    ...
    MaNGOS::IQueryCallback* m_callback;
    locked_queue* m_queue;

public:
    SqlQueryHolderEx(SqlQueryHolder* holder, MaNGOS::IQueryCallback* callback,
        locked_queue* queue)
