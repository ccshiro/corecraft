...
void SqlDelayThread::run()
{
    ...
    while (m_running)
    {
        ...
        // FIXME: wow another case of mangos being absolutely terrible, we need
        // to change
        // this so it properly reacts to an event such as an item getting added
        // to the queue
