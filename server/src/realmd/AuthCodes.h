...
enum AuthResult
{
    ...
    /// the spelling of the account name and password. If you need help
    /// in retrieving a lost or stolen password, see <site> for more
    /// information
    ...
    /// in retrieving a lost or stolen password, see <site> for more
    /// information
    // client reject next login attempts after this error, so in code used
    // WOW_FAIL_UNKNOWN_ACCOUNT for both cases
    ...
    /// suspended. Please go to <site>/banned.html for
    /// further information
    ...
    /// by parental controls. Your settings may be
    /// changed in your account preferences at
    ///<site>
    WOW_FAIL_LOCKED_ENFORCED =
        0x10, ///< You have applied a lock to your account. You can change your
    /// locked status by calling your account lock phone number.
    WOW_FAIL_TRIAL_ENDED = 0x11, ///< Your trial subscription has expired.
    /// Please visit <site> to upgrade your account.
