...
) ENGINE=MyISAM AUTO_INCREMENT=1045 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='Account System';
...
CREATE TABLE `realmlist` (
  ...
  `alliance_online` int(11) DEFAULT '0',
  `horde_online` int(11) DEFAULT '0',
  PRIMARY KEY (`id`),
